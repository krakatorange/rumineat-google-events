...
in the terminal you should be in project where inputs/outputs folders present, so write the command:
...
if not in windows please run the scraper using terminal command make sure you are in folder where inputs/outputs folders present
